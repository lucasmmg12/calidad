...
const rawChangelog: ChangelogEntry[] = [
    ...
    { hash: '370549e', date: '2026-02-11', type: 'fix', title: 'Botón Rechazar visible en formulario', description: 'Se agregó un botón "Rechazar Reclamo" visible dentro del formulario de resolución para el Responsable.' },
