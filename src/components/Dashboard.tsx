                                            ...
                                            <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 rounded-xl p-4 space-y-3">
                                                ...
                                                {selectedReport.contact_number && (
                                                    <div className="flex items-center justify-between gap-3 bg-white/60 rounded-lg p-3 border border-emerald-100">
                                                        ...
                                                        <a
                                                            href={`https://wa.me/549${selectedReport.contact_number.replace(/\D/g, '')}?text=${encodeURIComponent(`Hola ${selectedReport.contact_name || ''}, nos comunicamos del Departamento de Calidad del Sanatorio Argentino respecto a su reporte ${selectedReport.tracking_id}.`)}`}
                                                            target="_blank"
                                                            rel="noopener noreferrer"
                                                            className="flex items-center gap-2 px-4 py-2.5 bg-[#25D366] hover:bg-[#1fb855] text-white rounded-xl font-bold text-xs shadow-md shadow-green-200 hover:shadow-lg hover:scale-105 transition-all duration-200 active:scale-95"
