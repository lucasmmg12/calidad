        ...
        <div className="max-w-4xl mx-auto p-4 md:p-6 mb-20">
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-500">
                    Panel de gestión y monitoreo para tus sectores ({sectors.map(s => SECTOR_OPTIONS.find(o => o.value === s)?.label || s).join(', ') || 'ninguno'})
                </p>
            </div>
            ...
            <div className="flex border-b border-gray-200 mb-6">
                <button 
                    ...
                    className={`px-4 py-3 font-bold text-sm border-b-2 transition-colors ${activeTab === 'assignments' ? 'border-sanatorio-primary text-sanatorio-primary' : 'border-transparent text-gray-500 hover:text-gray-700'}`}
                >
                    Casos Asignados
                </button>
                <button 
                    onClick={() => setActiveTab('tracking')}
                    className={`px-4 py-3 font-bold text-sm border-b-2 transition-colors ${activeTab === 'tracking' ? 'border-sanatorio-primary text-sanatorio-primary' : 'border-transparent text-gray-500 hover:text-gray-700'}`}
                >
